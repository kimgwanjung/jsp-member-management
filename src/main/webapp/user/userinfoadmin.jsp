...
<div class="container">
  ...
  <table>
    ...
    <tr>
      <th>Phone</th>
      <td><%= dto.getRole().equals("일반사용자") ? "010-XXXX-XXXX" : dto.getPhone() %></td>
    </tr>
    <tr>
      <th>Email</th>
      <td><%= dto.getEmail() %></td>
  ...
  <div class="table-button-row">
    <input type="button" value="수정" onclick="location.href='LoginController.jsp?command=updatepage2&no=<%= dto.getNo() %>'">
